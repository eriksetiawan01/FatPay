...
class StaffController extends Controller
{
    ...
    return inertia('pembayaran/staff', [
        'siswa' => $siswa,
        'pos' => $pos,
        'tagihan' => $tagihan,
        'transaksi' => $transaksi,
...
public function storeBySiswa(Request $request)
{
    ...
    return redirect()->back()->with('success', 'Tagihan berhasil ditambahkan untuk siswa.');
        ...
        public function show($nis)
        {
            ...
            return inertia('Staff/Pembayaran/Detail', [
                'siswa' => $siswa,
                'tagihan' => $tagihan,
                'transaksi' => $transaksi,
            ]);
    ...
    public function bayar(Request $request, $nis)
{
    ...
    return redirect()->route('pembayaran.staff');
}
    ...
    return redirect()->route('pembayaran.staff')->with('success', 'Jenis pembayaran berhasil ditambahkan.');
    }
